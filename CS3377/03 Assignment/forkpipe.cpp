/**
 *Assignment 3 Fork Pipe Quotes
 *4/1/2024
 *Winston Shih
 *Uses forks to create a new process.
 **/
#include <stdlib.h>
#include <string.h>
#include <cstdlib>
...
void executeChildProcess(int pipeParentWriteChildReadfds[], int pipeParentReadChildWritefds[], char* lines[], unsigned noLines) {
    ...
    do{
        ...
        else
        {
            ...
            cout<<"In Child : Write to pipe pipeParentReadChildMessage sent"<<endl<<"Message: "<<receivedMessage<<endl;
